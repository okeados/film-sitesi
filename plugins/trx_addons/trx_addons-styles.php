...
if (!function_exists('filmax_trx_addons_get_css')) {
	add_filter('filmax_filter_get_css', 'filmax_trx_addons_get_css', 10, 4);
	function filmax_trx_addons_get_css($css, $colors, $fonts, $scheme='') {
...
.slider_style_default .slider_container.slider_controls_side .slider_controls_wrap > a:hover,
.slider_style_default .slider_outer_controls_side .slider_controls_wrap > a:hover {
	color: {$colors['inverse_link']};
	background-color: transparent;
...
/* Action */
.sc_action_item .sc_action_item_subtitle {						color:{$colors['text_link2']}; }
...
.sc_promo_blockquote .sc_promo_title,
.scheme_self.sc_promo_blockquote .sc_promo_title,
.scheme_self.sc_promo_blockquote .post_title a,
.scheme_self.sc_promo_blockquote a,
.sc_promo_blockquote a {
	color: {$colors['text_dark']};
}
.scheme_self.sc_promo_blockquote .post_title a:hover {
	color: {$colors['text']};
}
.sc_promo_blockquote .sc_promo_descr,
.scheme_self.sc_promo_blockquote .sc_promo_descr {
	color: {$colors['text']};
}
.sc_promo_blockquote .sc_item_button_simple.sc_promo_button,
.scheme_self.sc_promo_blockquote .sc_item_button_simple.sc_promo_button {
	color: {$colors['text_dark']};
}
.sc_promo_blockquote .go-wrap-info,
.scheme_self.sc_promo_blockquote .go-wrap-info {
	background-color: {$colors['bg_color']};
}
...
.sc_team_default .sc_team_item:hover .sc_team_item_title a {
	color: {$colors['text_link']};
}
.sc_team_default .sc_team_item_subtitle {
	color: {$colors['text']};
...
.sc_recent_news .post_meta .post_categories,
.sc_recent_news .post_meta .post_categories a {
	color: {$colors['alter_link2']};
}
.sc_recent_news .post_meta .post_categories a:hover {
	color: {$colors['alter_dark']};
}
...
.sc_recent_news_style_news-portfolio .post_title:before {
	background-color: {$colors['text_link2']};
}
...
.sc_blogger .sc_blogger_item .post_meta_item.post_categories a:hover {
	color: {$colors['text_link']};
}
...
.sc_blogger_default .post_link_wrap_hover a.post_link:hover {
  color: {$colors['inverse_link']};
}
