...
<div class="sc_testimonials_item">
	...
	<div class="sc_testimonials_item_author">
		<?php if ( has_post_thumbnail() ) { ?>
			<div class="sc_testimonials_item_author_avatar"><?php the_post_thumbnail( apply_filters('trx_addons_filter_thumb_size', filmax_get_thumb_size('tiny-extra'), 'testimonials-default'), array('alt' => the_title_attribute( array( 'echo' => false ) ) ) ); ?></div>
		<?php } ?>
